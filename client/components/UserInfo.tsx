	...
	return (
		<Link href={`/profile/${userProfileId}`}>
			<a
				...
				className='flex items-center justify-between w-full h-16 p-2 border border-gray-700 rounded-lg shadow-xl cursor-pointer hover:bg-gray-900 hover:bg-opacity-50'
			>
