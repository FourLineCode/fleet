		...
		<>
			<div className='w-full px-2 pt-2 border rounded-lg shadow-xl border-dark-700 animate-pulse lg:mx-auto lg:w-3/4'>
				<div className='flex space-x-1'>
					<div className='flex-shrink-0 w-12 h-12 mr-2 bg-gray-600 rounded-lg' />
				...
				<div className='flex space-x-1'>
					...
					<div className='w-full space-y-2'>
						...
						<div className='space-y-1'>
							...
							<div className='w-full h-64 bg-gray-600 rounded' />
						</div>
					</div>
				</div>
				<div className='w-full h-6 mt-1'>
					...
					<div className='w-full space-y-2'>
						...
						<div className='space-y-1'>
							...
							<div className='flex w-full h-64 space-x-1'>
								<div className='w-2/3 h-full bg-gray-600 rounded' />
								<div className='flex flex-col flex-1 h-full space-y-1'>
									<div className='flex-1 w-full bg-gray-600 rounded' />
									<div className='flex-1 w-full bg-gray-600 rounded' />
								</div>
							</div>
						</div>
