				...
				<div className='w-full'>
					<div className='flex flex-col pb-2 space-x-1 space-y-2 border-b border-gray-700'>
						...
						<div className='space-y-2'>
							...
							<div className='w-full h-5 bg-gray-400 rounded' />
							<div className='w-2/3 h-5 bg-gray-400 rounded' />
						</div>
						...
						<div className='flex items-center w-full h-full'>
							<div className='flex items-center flex-1 justify-evenly'>
								<div className='flex items-center justify-evenly'>
									<div className='w-10 h-5 bg-gray-400 rounded' />
								</div>
								...
								<div className='flex items-center justify-between w-full'>
									<div className='flex items-center space-x-1'>
										<div className='flex items-center space-x-2'>
											<span className='w-24 h-4 bg-gray-400 rounded' />
											<span className='w-16 h-4 bg-gray-400 rounded' />
										</div>
										<span className='text-white'>{' • '}</span>
										<span className='w-20 h-4 bg-gray-400 rounded' />
									</div>
								</div>
							...
							<div className='space-y-1'>
								<div className='flex items-center justify-between w-full'>
									<div className='flex items-center space-x-1'>
										<div className='flex items-center space-x-2'>
											<span className='w-20 h-4 bg-gray-400 rounded' />
											<span className='h-4 bg-gray-400 rounded w-14' />
										</div>
										<span className='text-white'>{' • '}</span>
										<span className='w-16 h-4 bg-gray-400 rounded' />
									</div>
